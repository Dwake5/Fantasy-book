...
export const GLANDRAGOR = namespace + 'GLANDRAGOR';
...
export const SENTRY_DIE = namespace + 'SENTRY_DIE';
export const SENTRY_LUCK = namespace + 'SENTRY_LUCK';
export const DOOR_OPEN = namespace + 'DOOR_OPEN';
export const FORK_DIE = namespace + 'FORK_DIE';
