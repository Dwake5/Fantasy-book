const gameData = [
  {
    id: 1000,
    text: `You are about to embark on an epic adventure a quest for the Crown 
    ...
    wherein lies the treasured crown. 
    
    In this solo fantasy roleplaying gamebook you may elect to become 
    either a wizard or a warrior. If you choose to be a warrior, a simple 
    combat system will allow you to fight the various creatures of Kakhabad 
    quickly and conveniently. If you choose wizardry as your skill, 
    you will learn to master a unique magic system found in no other 
    fantasy roleplaying game. As would a real Grand Wizard, you will 
    have to learn your spells for now.
    
    The spells available to you are found in the Spell Book, which is 
    published separately, and you will prepare for your journey by 
    memorizing these spells, you need not learn all the spells, for all 
    forty eight spells would be known only by a true Imperial Sorcerer. A 
    basic knowledge of as few as six spells will be enough for you to start 
    your journey. 
    
    Whether wizard or warrior, the journey ahead will be dangerous and 
    you will be faced with tricks, traps, problems and clues not to 
    mention the host of evil creatures which will try to prevent you 
    reaching your goal. 
    
    Through the multi-choice gamebook system, you will choose which 
    ...
    adventure again. But if your skill is great and if luck and your god is 
    with you, you may survive your overland journey to the Mampang 
    Fortress.`,
    choices: [{ goToPage: 1001, text: "Continue.. (tutorial 1/8)" }],
  },
  {
    id: 1001,
    text: `Before setting off on your journey, you must first build up your own 
    personality profile. Your own skill, stamina and luck scores 
    will be recorded here, and also the equipment, artefacts and treasures 
    you will find on your journey.
    
    Roll one die. If you are playing as a warrior (the simple game), add 6 to 
    ...
    There is also a luck box. Roll one die, add 6 to this number and enter 
    this total in the luck box. 

    For reasons that will be explained below, skill, stamina and luck 
    ...
    Initial scores, except on very rare occasions, when you will be instructed on a particular page. 
  `,
    choices: [{ goToPage: 1002, text: "Continue.. (tutorial 2/8)" }],
    options: { pause: true },
  },
  {
    id: 1002,
    text: `You will often come across pages in the book which instruct you to 
    ...
    First record the creature's skill and stamina scores in the first 
    ...
    1. Roll the two dice once for the creature. Add its skill score. This 
    total is the creature's Attack Strength. 
    
    2. Roll the two dice once for yourself. Add the number rolled to your 
    current skill score. This total is your Attack Strength. 
    ...
    blows start the next Attack Round from step 1 above. 
    
    4. You have wounded the creature, so subtract 2 points from its 
    stamina score. You may use your luck here to do additional 
    damage (see over). 
    
    5. The creature has wounded you, so subtract 2 points from your stamina 
    score. Again, you may use luck at this stage (see over). 
    
    6. Make the appropriate adjustments to either the creature's or your 
    own st amina score (and your luck score if you used luck see 
    over), 
    
    7. Begin the next Attack Round (repeat steps 1-6). This sequence 
    continues until the stamina score of either you or the creature 
    you are fighting has been reduced to zero (death).
    
    If you come across more than one creature in a particular encounter, 
    ...
    will fight each one in turn.`,
    choices: [{ goToPage: 1003, text: "Continue.. (tutorial 3/8)" }],
  },
  {
    id: 1003,
    text: `At various times during your adventure, either in battles or when you 
    ...
    luck is a risky business and if you are imlucky, the results could be 
    disastrous. 
    
    The procedure for using your luck is as follows: roll two dice. If the 
    ...
    This procedure is known as Testing your Luck. Each time you Test your 
    ...
    choices: [{ goToPage: 1004, text: "Continue.. (tutorial 4/8)" }],
  },
  {
    id: 1004,
    text: `Using Luck in Battles 

    On certain pages of the book you will be told to Test your Luck and will 
    ...
    minimize the items of a wound l he creature has just inflicted on you. 
    
    If you have just wounded the creature, you may Test your Luck as 
    ...
    the normal 2 points of damage, you have now scored only 1), 
    
    If the creature has just wounded you, you may Test your Luck to try to 
    ...
    doing 2 points of damage it has done only t). If you are Unlucky , you 
    have taken a more serious blow. Subtract 1 extra stamina point. 
    
    Remember that you must subtract 1 point from your own luck score 
    each time you Test your Luck.`,
    choices: [{ goToPage: 1005, text: "Continue.. (tutorial 5/8)" }],
  },
  {
    id: 1005,
    text: `Your skill score will not change much during your adventure. 
    ...
    score can never exceed its Initial value unless specifically instructed. 
    
    Your stamina score will change a lot during your adventure as you 
    ...
    You start with enough Provisions for two meals. You may rest and eat 
    ...
    manage your Provisions wisely! 
    
    Remember also that your stamina score may never exceed its Initial 
    value unless specifically instructed. 
    
    
    Additions to your luck score are awarded through the adventure 
    ...
    score may never exceed its Initial value unless specifically instructed.`,
    choices: [{ goToPage: 1006, text: "Continue.. (tutorial 6/8)" }],
  },
  {
    id: 1006,
    text: `All the spells known 
    ...
    All spells are coded with a three-letter code and you must learn and 
    ...
    Full rules for using spells are given in the Spell Book ; 
    
    Don't forget! You may not refer to the spell book once you have 
    started your adventure`,
    choices: [{ goToPage: 1007, text: "Continue.. (tutorial 7/8)" }],
  },
  {
    id: 1007,
    text: `During your adventure you will be watched over by your own 
    ...
    There are three ways in which she may help you: 
    
    Revitalization: You may call on her at any time to restore your skill, 
    stamina and luck scores to their Initial values. 
    You may do this if and when you wish, but only once. 
    
    Escape: Occasionally, when you are in danger, the text will offer you 
    the option of calling on Libra to help you. 
    
    Removal of Curses and Diseases: She will remove any curses or 
    diseases you may pick up on your adventure. You may do this if and when you wish, but only 
    once.`,
    choices: [
      {
        goToPage: 1008,
        text: "Continue.. (tutorial 8/8)",
      },
    ],
  },
  {
    id: 1008,
    text: `You start your adventure with the bare necessities of life. You have a 
    sword as your weapon, and a backpack to hold your equipment, 
    treasures, artefacts and provisions. You cannot take your Spell Book 
    with you, as the sorcerers of Analand cannot risk its falling into the 
    wrong hands in Kakhabad so you may not refer to this book at all 
    once you have started your journey. 
    
    You have a pouch around your waist containing 20 Gold Pieces, the 
    ...
    gold as you progress on your way* 
    
    You are also carrying Provisions (food and drink) sufficient for 2 
    ...
    food: you cannot afford to run out of Provisions.`,
    choices: [
      {
        goToPage: 1009,
  ...
  {
    id: 1009,
    text: `Centuries ago, in the time we now call the Dark Ages, whole regions 
    of the world were undiscovered. There were pockets of civilization, 
    each with their own races and cultures. One such region was Kakhabad, 
    a dark land at the end of the earth. 
    
    Although several warlords had tried, Kakhabad had never been 
    ruled. All manner of evil creatures, forced from the more civilized 
    lands beyond the Zanzunu Peaks, had gradually crawled into Kakhabad, 
    which became known as the Verminpit at Earth End. 
    
    Civilization and order had spread throughout the rest of the known 
    world ever since the discovery of the Crown of Kings by Chalanna the 
    Reformer, of Femphrey. With its help, Chalanna became Emperor of 
    the largest empire in the eastern world. This magical Crown had 
    mysterious powers, bestowing supernormal qualities of leadership 
    and justice on its owner. But Chalanna's own ambitions were not of 
    conquest. He wished instead to establish peaceful nation-states, 
    aligned to Femphrey. Thus in his wisdom he passed the fabled Crown 
    from ruler to ruler in the neighbouring kingdoms, and, with the help 
    of its magical powers, one by one these lands became peaceful and 
    prosperous. 
    
    The path was set. Each ruler would own the Crown of Kings for a 
    four-year period in which to establish order within his kingdom and 
    fall in with the growing Femphrey Alliance. So far the kingdoms of 
    Ruddles tone, Lendleland, Gallantaria and Brice had taken their turns 
    under the rule of the Crown. The benefits were immediate. War and 
    strife were virtually unknown. 
    
    The King of Analand duly received the Crown of Kings amid great 
    ceremony, and, from that day onwards, the development of Analand 
    was ensured. No one quite knew how the Crown of Kings could have 
    such an enormous uplifting effect on a whole nation. Some said it was 
    divinely inspired; some that its power was merely in the mind. But 
    one thing was certain its effects were unquestionable. All was well 
    in Analand, until the night of the Black Moon. 
    
    The King was the first to discover that the Crown was missing. 
    Carried off on that starless night by Birdmen from Xamen, the 
    Crown was on its way to Mampang in the outlaw territories of 
    Kakhabad. News came from the Baklands that the Crown was being 
    carried to the Archmage of Mampang whose ambitions were to make 
    Kakhabad his kingdom. 
    
    Although Kakhabad was a dangerous land, it was in itself little threat 
    to the surrounding kingdoms. The lack of rule meant it had no army 
    and its own internal struggles kept it permanently preoccupied. But 
    with the Crown of Kings to establish rule, Kakhabad could potentially 
    be a deadly enemy to all members of the Femphrey Alliance. 
    
    Such was the shame that fell on Analand for the loss of the Crown that 
    all benefits from two years under its rule soon disappeared. Law, 
    order and morale were breaking down. The King was losing the 
    confidence of his subjects. Neighbouring territories were looking 
    suspiciously across their borders. There were even whisperings of 
    invasions. 
    
    One hope remained. Someone for a military force would never 
    survive the journey must travel to Mampang and rescue the Crown 
    of Kings. Only on its safe return would the dreadful curse be lifted 
    from Analand. You have volunteered yourself for this quest and your 
    mission is clear. You must cross Kakhabad to the Mampang Fortress 
    and find the Crown!`,
    choices: [{ goToPage: 1, text: "Continue.." }],
  },
  {
    id: 1,
    text: `You awake at sunrise. After dressing, you breakfast on bread and 
    ...
    meals as the day's guard takes over. 
    
    Eyes follow you as you leave your hut and walk towards the Shamutanti Wall. 
    The frontierspeople are well aware of your mission and a 
    small crowd of well-wishers follows some distance behind you. 
    
    Before you stands the Cantopani Gate. Guarded constantly by Sight- 
    master Warriors, chosen for their powers of telescopic vision, the 
    Gate is the final doorway between Ana land and Kakhabad. Once 
    more you check your pack. 
    
    Satisfied that your preparations are complete, you nod to the Sight- 
    ...
    view of the Shamutanti foothills, the first stage of your journey. 
    
    The Sight master Sergeant strides over and grasps your hand. 1 will 
    ...
    Take the path ahead to Cantopani, a small settlement of traders - 
    although most are rogues and thieves which you should reach 
    within the hour. From Cantopani onwards there are three routes 
    through Birritanti to Khare, acityporton the Jabaji river. From Khare 
    you must cross the Baklands, which are unknown, it is said that day 
    and night in the Bakiands are controlled not by the sun but by 
    supernatural forces; and bear in mind also that, from Khare onwards, 
    your progress will be watched/ 
    
    His warnings do little to inspire confidence in you. He continues: But 
    ...
    You shake his hand, thank him for his good w ishes and step up to the 
    ...
    With a wave, you turn and face the hills. The early morning air is crisp 
    and the rising sun paints the hills in colours of natural beauty which 
    conceal the devilry ahead. 
  ...
  {
    id: 3,
    text: `Following the passage down for some distance, you reach a T- 
    junction where you may turn left or right.`,
    choices: [
  ...
  },
  {
    ...
    try using it on the door by subtracting 10 from the number on the key 
    and turning to that reference, or you may try a spell: 
    ...
    choices: [
      ...
      { goToPage: 142, text: "Try breaking the lock" },
      // todo sort out keys
    ],
  },
  {
    ...
    bag. He will charge you 3 Gold Pieces for the bag of teeth. Buy if you 
    will.`,
    choices: [
      {
        goToPage: 280,
  ...
  },
  {
    ...
    afternoon until you reach a point wTiere you can see that it is running 
    into a hill village.`,
  ...
  },
  {
    ...
    signpost, reading to a lianna, points into the wood. Will you set 
  ...
  {
    id: 11,
    text: `You pull out your bamboo pipe and begin to play. Somehow the 
    unseen musicians adapt their tune to accommodate you and play 
    away merrily for half an hour or so. You may add 3 stamina points 
    and 1 luck point for your restful encounter. Then you pick yourself 
  ...
  },
  {
    ...
    One of them rises into the air and flics across, hovering over you to 
  ...
  },
  {
    ...
    hillside. If this is your first meal today, add 2 stamin a points. If you 
    have already eaten since leaving Ana I and, add only 1 stamina point.`,
  ...
  {
    id: 20,
    text: `The creature is a SKUNKBEAR and, when you draw your weapon, it 
    raises its tail, releasing a nauseating odour. The smell is horrendous, 
    but you must fight: 
    
    SKUNKBEAR skill 7 stamina 5 
    
    The effect of the smell is so powerful that you must deduct 2 points 
    from your dice roll each time you roll for Attack Strength. If you beat 
    the creature.`,
  ...
  },
  {
    ...
    Add 3 stamina points for the rest.`,
    choices: [{ goToPage: 67, text: "Continue.." }],
  },
  {
    id: 22,
    text: `Roll 1 die. This is the price, in Gold Pieces, that the merchant is asking 
    for the pipe. If you will pay this price, purchase the instrument`,
    choices: [
      {
        goToPage: 264,
        text: "Buy the pipe, and return to the trader",
      },
      { goToPage: 264, text: "Do not buy the pipe, return to the trader" },
    ],
  },
  {
    id: 23,
    ...
    twenty-minute rests.`,
    choices: [
      { goToPage: 245, text: "Rolled a 1 or 2" },
      { goToPage: 69, text: "Rolled a 3 or 4" },
      { goToPage: 99, text: "Rolled a 5 or 6" },
      { goToPage: 167, text: "Succesfully tested your luck" },
    ],
  },
  {
    id: 24,
    ...
    choices: [
      ...
      { goToPage: 277, text: "Dont use spells" },
    ],
  },
  {
    id: 25,
  ...
  },
  {
    ...
    Or will you try some other means of escape? You may call 
    on Libra's help if you have not yet summoned her.`,
    choices: [
  ...
  },
  {
    ...
    bridge, barring your w r ay. In a gruff voice he speaks to you: 
  ...
  },
  {
    ...
    choices: [
      ...
      { goToPage: 92, text: "Leave the inn" },
  ...
  },
  {
    ...
    Ana land? If not, you are feeling very hungry and must lose 3 
    stamina points.`,
  ...
  },
  {
    ...
    'but you have two paths ahead. My advice, though, is not free. For 2 
    Gold Pieces I will tell you what I know. You may accept his offer, or refuse and press 
    onwards.`,
    choices: [
      {
        goToPage: 225,
  ...
  },
  {
    ...
    You may either throw one die or Test your luck`,
    choices: [
      { goToPage: 23, text: "Throw one die" },
  ...
  },
  {
    ...
    are now hungry and must lose 3 stamin a points. 
  ...
  {
    id: 47,
    text: `The Goblin senses your defiance and rises, with a large stone club in 
    his hand. You may fight him: 
    
    GOBLIN SKILL 7 STAMINA 6 
    
    Alternatively, you may cast a spell:`,
    choices: [
  ...
  },
  {
    ...
    any two objects in your bag which you know are useful in magic spells 
    and then she magically transports you and your miniature companion 
    (together with the rest of your possessions) out into the woods 
    where the drug eventually wears off.`,
    choices: [
      { goToPage: 77, text: "I have a spellbook page" },
      { goToPage: 232, text: "I don't have a spellbook page. Continue.." },
    ],
  },
  {
    id: 49,
  ...
  },
  {
    ...
    studded with green gems and looks quite valuable. You may take it if 
    you wish and then you had better leave the village.`,
    choices: [
      { goToPage: 196, text: "Take it" },
      { goToPage: 196, text: "Don't take it" },
    ],
  },
  {
    id: 51,
    ...
    watched. As you are now in a wood, you proceed cautiously. Sud- 
    denly the bushes part and a figure steps forward. Dressed in black, 
  ...
  },
  {
    ...
    village. You have a good night's sleep. Add 3 stamina points.`,
    choices: [{ goToPage: 67, text: "Continue.." }],
  },
  {
    id: 56,
  ...
  },
  {
    ...
    sack of some kind. Bending down to pick it up, you find it is a pouch 
    containing 12 Gold Pieces! You put this in your backpack. But as you 
    ...
    nothing else to lose - and cross it off your Adventure Sheet. As you 
    ...
    choices: [{ goToPage: 159, text: "Continue.." }], // todo remove on item add 12 gold
  },
  {
    id: 58,
  ...
  },
  {
    ...
    surge through your body. Lose 2 stamina points and 1 luck point 
  ...
  },
  {
    ...
    mount. His price is 10 Gold Pieces. Buy the jewel if you wish.`,
    choices: [
      {
        goToPage: 280,
  ...
  },
  {
    ...
    continually by strange noises. Add 1 stamina point forgetting some 
  ...
  },
  {
    ...
    choices: [
      ...
      { goToPage: 228, text: "Break the door down" },
    ],
  },
  {
    id: 67,
    ...
    you must deduct 3 stamina points. 
  ...
  },
  {
    ...
    which reads: This axe was crafted in the Year of the Ox for Glandra- 
    gor the Protector. Its powers may be realized only by its owner." It also 
  ...
  {
    id: 74,
    text: `You approach the hut and call through the doorway. No Teply. You 
    ...
    that, as you look around, an eye opens on the skin's head. 
    
    Your back is towards the rug and you cannot see it rising up and 
    taking on its natural shape - that of a WOLFHOUND - until it snarls 
    menacingly and attacks. You will have to fight it: 
    
    WOLFHOUND skill 7 stamina 6 
    
    Or you may fight it with magic:`,
    choices: [
  ...
  },
  {
    ...
    thin, man-iike creatures, glowing with a dull red luminescence, are 
  ...
  {
    id: 77,
    text: `She comes across the Spell Book page and drops your pack. 'My 
    ...
    cup of liquid which she pours into your mouth. This antidote gradually takes effect, unfreezing your body. She slaps you gently to 
    bring you round.`,
  ...
  },
  {
    ...
    choices: [
      ...
      { goToPage: 0, text: "Help with swordplay" },
    ],
  },
  {
    id: 79,
    ...
    spring back, but it is too late. You have made contact with a plague 
    carrier and from now onwards you will lose 3 stamina points each 
    day until you either die or you find someone who can cure you of 
    the plague. Deduct your points first thing in the morning. You are 
  ...
  },
  {
    ...
    place appears to be deserted. A fire bums in the centre of the camp in 
  ...
  {
    id: 87,
    text: `In addition, she hands you a bag containing 7 Gold Pieces. Then she 
    ...
    now advances towards you! Will you fight the creature or cast a spell?
  ...
  },
  {
    ...
    Do you have a musical pipe with you? If so, you may take it out and 
    play along.`,
    choices: [
      { goToPage: 11, text: "Play your pipe (if you have one)" },
  ...
  },
  {
    ...
    choices: [
      { goToPage: 0, text: "Magical item" },
      { goToPage: 0, text: "Aid in combat" },
    ],
  },
  {
    id: 91,
    text: `You bid the merchant farewell and leave the hut. Look at your items or continue onwards`,
    choices: [
      { goToPage: 126, text: "View artefacts" },
      { goToPage: 0, text: "Continue.." },
    ],
  },
  {
    id: 92,
  ...
  },
  {
    ...
    give up your attempts, you may return to the junction and leave the cave.`,
    choices: [
  ...
  },
  {
    ...
    As you leave the heavy foliage, the grip on your arm is released. Add 1 
    luck point. Still you cannot see who, or what, was responsible for the 
    guidance.`,
  ...
  {
    id: 96,
    text: `You sit down and the young man turns towards you eagerly. Even- 
    tually your presence is tolerated at the ale-house and the others get 
  ...
  {
    id: 97,
    text: `You may take these Provisions with you.`,
  ...
  {
    id: 101,
    text: `You try the key but it does not fit. Try another 
    choice.`,
    choices: [{ goToPage: 4, text: "Continue.." }], // This wont be reached in the code its key number - 10
  },
  {
    id: 102,
    ...
    choices: [
      { goToPage: 204, text: "Visit the waterfall" },
      { goToPage: 94, text: "Head to the inn" },
  ...
  },
  {
    ...
    choices: [{ goToPage: 107, text: "Continue.." }],
  },
  {
    id: 104,
    text: `The bandits growl and advance. Yon may fight them in turn or use magic: 

    First BANDIT skill 7 stamina 6 
    Second BANDIT skill 7 stamina 5`,
    choices: [
  ...
  {
    id: 106,
    text: `Further along the way you come across a couple of merchants' huts 
    and you browse through the items for sale. If you wish, and if you can 
    afford it, you may buy any of the following items: 
    
    A finely crafted sword: 6 Gold Pieces 
    
    A woven skullcap: 4 Gold Pieces 
    
    Provisions for three meals: 6 Gold Pieces
    
    You may also ask them whether they know of any 
    work that may be going, or if you don't wish to deal with 
    them at all, you may head for the inn for the night.`,
    choices: [
      { goToPage: 194, text: "A finely crafted sword" },
      { goToPage: 247, text: "A woven skullcap" },
      { goToPage: 97, text: "Provisions for 3 meals" },
  ...
  {
    id: 107,
    text: `For this potion, he demands 4 Gold Pieces and the price is not 
  ...
  {
    id: 108,
    text: `You find a suitable spot in the woods to make your camp. If you have 
    not eaten yet today, you may do so if you have Provisions and you 
    will gain 2 stamina points. If you have already eaten today you will 
    gain only 1 stamina point if you have a meal. 
    ...
    You may set off again the next morning. If you have had a peaceful 
    ...
    choices: [
      // todo fight night creatures at 123 first
      { goToPage: 36, text: "Continue.." },
    ],
  },
  {
    id: 109,
    text: `You may add 2 stamina points for your rest. If you did not eat at 
  ...
  },
  {
    ...
    visit the tavern, head for the Crystal 
    Waterfall or leave town straight away?`,
    choices: [
  ...
  },
  {
    ...
    settlement. Several natives rush off to fill a large pot with w r ater to be 
    ...
    choices: [
      { goToPage: 25, text: "Pray to Libra" },
      { goToPage: 242, text: "Dont pray to Libra" },
    ],
  },
  {
    id: 113,
  ...
  },
  {
    ...
    how useful it is. She will rid you of the Minimite pest if you wish. If 
    you want to get rid of Jann and regain your ability to use spells, add 
    together the page number you have with the number on what must be 
    the next page and turn to that reference number. If you have not 
    recorded the page number, or if you wish to keep Jann, she allows 
    you to leave and set off again along the path.`,
    choices: [{ goToPage: 232, text: "Continue" }], // todo go to reference number
  },
  {
    id: 115,
    text: `You pay the 3 Gold Pieces and settle down for the night. You may add 
    2 stamina points for a refreshing night's sleep.`,
    choices: [{ goToPage: 30, text: "Continue.." }],
  },
  {
    id: 116,
    text: `The meal is warm and nourishing. Add 2 stamina points.`,
    choices: [{ goToPage: 131, text: "Continue.." }],
  },
  {
    id: 117,
    text: `You prepare to fight the tall ASSASSIN, or you may cast a spell: 
    ...
    You may choose to kill him, alternatively you may elect to spare 
    his life when he is reduced to 3 stamina points or less, so long as you 
    are clearly winning (i.e. your own stamina is at least 6)`,
    choices: [
      ...
      { goToPage: 187, text: "Spare him" },
      { goToPage: 153, text: "Kill him" },
    ],
  },
  {
    id: 118,
  ...
  },
  {
    ...
    choices: [
      ...
      { goToPage: 144, text: "Return the cave entrance" },
    ],
  },
  {
    id: 121,
  ...
  },
  {
    ...
    choices: [
      ...
      { goToPage: 31, text: "Continue.." }],
    // todo go to previous reference
    enemies: [
      { name: "Giant Bat", skill: "5", stamina: "5" },
      { name: "Giant Bat", skill: "5", stamina: "5" },
      { name: "Wolfhound", skill: "7", stamina: "6" },
      { name: "Werewolf", skill: "8", stamina: "9" },
      { name: "", skill: "", stamina: "" },
      { name: "", skill: "", stamina: "" },
    ],
  },
  {
    ...
    back inside the box. You wonder at the Spirit's curse, but there is little 
    you can do. Until you find some way of ridding yourself of this curse, 
    your stamina has been weakened. Each time you lose stamina 
    points for any reason except casting spells , you must lose 1 extra 
    stamina point. You may search for some means of ridding yourself 
    of the Spirit's curse for, until you do, you are more vulnerable to 
  ...
  {
    id: 126,
    text: `You may investigate your purchases now. A brief description can be seen by hovering over the item in the item box.
    
    You will return here after investigating all your new acquisitions.
    Continue onwards, once you are ready.`,
    choices: [
      { goToPage: 274, text: "View the potion" },
      { goToPage: 43, text: "View the broadsword" },
      { goToPage: 249, text: "View the pipe" },
      { goToPage: 72, text: "View the axe" },
      { goToPage: 190, text: "View the teeth" },
      { goToPage: 152, text: "View the jewel" },
  ...
  },
  {
    ...
    alone. You may add 1 luck point for getting this lift. You travel for 
    ...
    may offer to help him for an hour or so in return for the lift or you may leave him and continue your journey.`,
    choices: [
  ...
  },
  {
    ...
    drowned as the water fills all the available space. Will you cast a spell,
    ...
    choices: [
      ...
      { goToPage: 64, text: "I have another plan" },
      { goToPage: 260, text: "Call Libra" },
    ],
  },
  {
    id: 131,
  ...
  },
  {
    ...
    gives way underfoot. You may Test your Luck. If you are Unlucky, turn 
    to 70. If you are Lucky, turn to 89. If you would prefer not to Test your 
    Luck, turn to 70. `,
    choices: [
      { goToPage: 89, text: "Test your Luck - Success" },
      { goToPage: 70, text: "Test your Luck - Fail" },
      { goToPage: 70, text: "Dont test your luck" },
  ...
  },
  {
    ...
    stamin a points if this is not your first meal. You can stay at the 
  ...
  },
  {
    ...
    many more battles. The merchant wants 7 Gold Pieces for the 
    weapon. You may pay his price and take the axe, or you may bargain. 
  ...
  },
  {
    ...
    have two weapons, you may use the less favoured one so as to suffer 
    no penalty when using your normal weapon. You must try at least 
    once but, after this, you may stop at any time, give up and leave the 
    house.`,
    choices: [
      { goToPage: 90, text: "Successful roll - break the lock" },
      { goToPage: 278, text: "Give up and leave the house" },
    ], // todo a lot
  },
  {
    id: 143,
  ...
  },
  {
    ...
    choices: [
      { goToPage: 251, text: "Open the left box" },
      { goToPage: 258, text: "Open the right box" },
    ],
  },
  {
    id: 146,
    text: `The tea is refreshing and you may add 1 stamina point. Also add 1 
    luck point for making the right choice. You notice that the woman is 
    ...
    choices: [
      { goToPage: 184, text: "I have a Spell Book page" },
  ...
  },
  {
    ...
    Alianna and straight on to Dhumpus. Wilt you head for Alianna or Dhumpus?`,
    choices: [
  ...
  {
    id: 153,
    text: `Looking through his pockets you find 3 Gold Pieces. You mav now set 
  ...
  },
  {
    ...
    you enter the house or leave well alone?`,
    choices: [
  ...
  {
    id: 155,
    text: `Searching the bodies, you find a miserable 2 Gold Pieces in their 
    pockets. You also take 8 teeth, which lie on the ground next to 
    the first Goblin.`,
  ...
  },
  {
    ...
    may rest and eat Provisions if you wish. Or if you can continue.`,
    choices: [
      { goToPage: 18, text: "Eat Provisions" },
  ...
  },
  {
    ...
    from you. Will you hold out your hand in friendship or 
    cast a spell?
  ...
  },
  {
    ...
    hear a great crashing from the tunnel. 
    
    You have now called on Libra for help, your one and only lime 
  ...
  },
  {
    ...
    Provisions at the inn. If you wish to rest for the night, pay the 3 Gold 
    Pieces. The bed you are given is not particularly clean, but is comfort- 
    able and you may add 5 stamina points for a good night's rest.`,
    choices: [
      { goToPage: 62, text: "Eat and don't rest" },
      { goToPage: 43, text: "Stay the night" },
    ],
  },
  {
    id: 162,
    text: `You must fight the Giant: 
  ...
  {
    id: 164,
    text: `The path winds alongside a bubbling stream and you follow it on- 
    wards along the west bank. The valley you are in becomes narrower, 
  ...
  },
  {
    ...
    choices: [{ goToPage: 245, text: "Continue.." }],
  },
  {
    id: 168,
    ...
    contents, but it is too late: the little creature has eaten all your 
    Provisions. You are angry at your own carelessness and set oft briskly 
  ...
  },
  {
    ...
    junction where you may head north towards Dhumpus.`,
    choices: [{ goToPage: 54, text: "Continue.." }],
  },
  {
    id: 170,
    text: `Your relief is somewhat premature, however, as you discover when 
    you take your next step forward. Your foot triggers a release mechan- 
    ism and three saplings snap up In front of you. Each is fitted with 
  ...
  },
  {
    ...
    Birritanti or will you tell it you would rather travel atone?`,
    choices: [
  ...
  {
    id: 172,
    text: `You call into the hut hut there is no reply. Parting the drapes, you look 
  ...
  {
    id: 173,
    text: `He is grateful for the help and offers you vegetables to take with you 
    on your journey - enough for one meal - as payment. Then you leave 
  ...
  },
  {
    ...
    containing 3 Cold Pieces, Around the Troll's neck is a small amulet 
  ...
  {
    id: 178,
    text: `The path winds through fields of wild scrubland. The countryside is 
    ...
    downwards into a small settlement of huts at the base of the Shamu- 
    tanti Hills. You follow the path and, as you approach the village, 
    noises and movements indicate that it is populated. As the path runs 
    straight through the village, you have little choice but to follow it. 
    
    The round huts are made of a hard-baked, bright clay with thatched 
  ...
  {
    id: 182,
    text: `What will you give the man? If you have an axe, turn to the number 
    carved on the axe. If you do not have an axe, you will now have to give 
    him something else.`,
    choices: [
      { goToPage: 233, text: "Give him the axe" },
      { goToPage: 29, text: "I don't have an axe" },
    ],
  },
  {
    id: 183,
    text: `You ponder the two trails. As you consider the paths onwards, you 
    ...
    jump down to the ground, which considering his age is not surpris- 
    ing. He pleads with you to assist and you help him down. It transpires 
    ...
    for your kindness, he relates a rhyme which he feels may help you; 
    ...
    He is not sure exactly what the rhyme signifies, but he knows that the 
    Elvins are particularly keen on finding the key in question. He also 
    presses on you his only possession: a page from a Spell Book. The spell described is incomplete; you have only part of 
    it. Looking at it, it appears to be some sort of pest-repelling spell. He 
    then bids you farewell and heads off towards Cantopani. 
  ...
  {
    id: 185,
    text: `You sit and talk with them. They seem to be amongst the senior 
    members of the village society and this has been a lucky encounter 
    (add 2 luck points). They offer you food, which you may eat for a 
    gain of 1 stamina point. As the conversation becomes lighter, you 
    ...
    the edge of the village he gives up the chase and you may head 
    onwards — but you realize with dismay that you have left your 
    weapon behind! You must now continue weaponless and, unless you 
    have a reserve in your pack, you must deduct 4 skill points until you 
    find another weapon.`,
  ...
  },
  {
    ...
    Add 2 luck points and continue.`,
  ...
  },
  {
    ...
    and each is a different colour. You may investigate one with a red 
    doorway, a green doorway or a brown 
    doorway.`,
    choices: [
  ...
  },
  {
    ...
    can add 2 stamina points for the ale and 1 luck point for the 
    ...
    out of the village but you cannot lose the little creature`,
    choices: [
      { goToPage: 92, text: "To the inn" },
  ...
  },
  {
    ...
    of what comes and goes in Krista tanti. He has heard of the capture of 
    ...
    exchange Goblin jokes. Eventually, he stands to leave. There arc two 
    ways onwards from Krista tanti, stranger/ he says. 'One will take you 
  ...
  {
    id: 194,
    text: `The sword has a specially sharpened blade and will inflict 3 sta m i n a 
    ...
    leave your old one behind. If you don't consider this new sword is as 
  ...
  },
  {
    ...
    choices: [
      ...
      { goToPage: 227, text: "Fight the creature" },
    ],
  },
  {
    id: 196,
    text: `Cautiously, you leave the village and follow the river upstream for an 
    hour.`,
    choices: [{ goToPage: 231, text: "Continue.." }],
  },
  {
    ...
    torch and linderbox to light your way. Lighting up the torch you can 
  ...
  {
    id: 199,
    text: `The key is old and rusty and a number is stamped into it. You can just 
    make out the figure on the key: 54. You put this in your backpack 
    and then either leave the village quickly or try the other 
    box on the table.`,
    choices: [
  ...
  },
  {
    ...
    bees are buzzing. You may climb up the tree to investigate or ignore it and continue onwards.`,
    choices: [
  ...
  {
    id: 201,
    text: `The job is indeed unpleasant. The villager feeds you (add 2 stamina 
      points) but you lose 3 stamina points for missing a night's sleep. 
  ...
  {
    id: 203,
    text: `Sensing your attitude, the creature pulls a short sword from its belt. It 
    ...
    has happened, the sharp sword has grazed your arm, inflicting 1 
    stamina point's worth of damage. You may fight this little ELVIN, 
  ...
  },
  {
    ...
    properties. You may restore your skill, stamina and luck scores to 
    their Initial values for washing away your wounds. The waterfall will 
    also cure you of any diseases you may have picked up (but not 
    curses). Then you must return to the village where you pass the inn.`,
  ...
  {
    id: 206,
    text: `You are surrounded by dead snakes. Your luck held out, but your 
  ...
  },
  {
    ...
    choices: [
      { goToPage: 161, text: "Purchase from the inn" },
  ...
  },
  {
    ...
    threat. The Curse of Alianna reduces your skill score by 2 points 
    from now until such time as the curse is removed. Quickly you look 
    through drawers and cupboards but succeed only in finding a pouch 
    containing soft brown sand, and 2 Gold Pieces. You take these 
  ...
  {
    id: 217,
    text: `You have been unlucky and are noticed by a small group of 3 Goblins 
    who come at you armed with picks; 
    
    FIRST GOBLIN skill 5 stamina 4 
    
    SECOND GOBLIN skill 6 stamina 4 
    
    THIRD GOBLIN skill 5 stamina 5 
  ...
  },
  {
    ...
    these caves are inhabited by Giants! You may take anything - or any 
    part of anything - on the floor that you wish with you, but if you take 
    the stool, you will not be able to carry anything else so you will have to 
    leave all your other possessions except your weapon. Then you may 
    leave and go either into the other cave or leave the caves 
  ...
  },
  {
    ...
    brings in bread and milk. You may eat this meal and add 2 stamina 
    points. 
    
    The chief explains that you have a mission of the utmost importance 
    ...
    It is dear that, in spite of the chiefs apparent good nature, you have 
  ...
  },
  {
    ...
    choices: [
      ...
      { goToPage: 244, text: "Give the beggar some gold" },
    ],
  },
  {
    id: 227,
    ...
    MANTICORE skill 12 stamina 18 
    
    Each time the creature inflicts a wound on you, you must roll one die. 
    A roll of a 5 or 6 indicates a hit with its scorpion-like tail containing a 
    poison which will cause 6 stamina points' worth of damage unless 
    you successfully Test your Luck (if you are Lucky, the damage will be 
    normal). If you roll a 1-4, the attack is normal.`,
  ...
  },
  {
    ...
    goddess Libra.`,
    choices: [
      { goToPage: 120, text: "Dice roll - Success" },
      { goToPage: 160, text: "Call Libra" },
    ],
  },
  {
    id: 229,
    ...
    to do, but he will feed and pay you. If you wish to take up this offer? If not, you must look for the inn.`,
    choices: [
  ...
  },
  {
    ...
    strangers. He is also a businessman, and a mug of ale will cost you 2 
    Gold Pieces, Will you pay up and drink your ale and talk to him,
    Or do you have something for him?`,
    choices: [
      { goToPage: 191, text: "Buy the drink and talk" },
      { goToPage: 182, text: "I have something for him" },
      { goToPage: 92, text: "Neither" },
    ],
  },
  {
    id: 231,
  ...
  },
  {
    ...
    overjoyed. Handing you a free mug of ale (you add 2 stamina 
    points for this) he is overwhelmingly grateful and wishes to tell you 
    all he knows to help you. 'First of all' he says, 'you should visit the 
    Crystal Waterfall. It has great powers of healing and soothing. Here is 
    a pass which will allow you past the guardian (you need not pay if you 
    ...
    Add 3 luck points for finding Glandragor. You may head for either 
  ...
  },
  {
    ...
    passageway. You may cast a spell if you wish.
    Or you may grope down the passageway in the dark. You 
    may decide against this passage and return through the room to the 
    junction.`,
    choices: [
  ...
  },
  {
    ...
    choices: [
      { goToPage: 48, text: "Switch the cups" },
      { goToPage: 146, text: "Wait for her to get back" },
    ],
  },
  {
    id: 244,
    ...
    watched over prisoners in the gaol. But Khare is an evil place, 
    inhabited by all manner of creatures. Beware the Red-Eyes in Khare or 
  ...
  },
  {
    ...
    be sure which path vou are warned not to take! Will you continue 
  ...
  {
    id: 249,
    text: `I he pipe is made of bamboo and you blow it. It gives off a lively little 
  ...
  },
  {
    ...
    path.`,
    choices: [
      { goToPage: 68, text: "Dice roll: 1 or 2" },
      { goToPage: 13, text: "Dice roll: 3 or 4" },
      { goToPage: 98, text: "Dice roll: 5 or 6" },
    ],
  },
  {
    id: 255,
  ...
  },
  {
    ...
    worth is 2 Gold Pieces. You can sit down and eat. If 
    you wish to buy Provisions, do so and pay the 2 Gold Pieces. 
    Or, you can continue with or without new Provisions.`,
    choices: [
      { goToPage: 116, text: "Sit down and eat" },
  ...
  },
  {
    ...
    the Scorpion and must lose half your stamina (round down any odd 
    stamina points). When you are finished with this box, turn to 199 if 
    you took the key. Otherwise you may either try the other box or leave the village.`,
    choices: [
      { goToPage: 199, text: "If you took the key" },
      { goToPage: 251, text: "Try the other box" },
      { goToPage: 196, text: "Leave the village" },
    ],
  },
  ...
  },
  {
    ...
    You fall to the ground dazed and the bandits make off with vour 
    belongings. Lose 2 stamina points. You have now lost everything you 
    were carrying in the backpack including gold and Provisions (but not 
    your sword). Eventually you pick yourself up and continue your 
    journey.`,
    choices: [{ goToPage: 131, text: "Continue.." }],
  },
  {
    ...
    You consider these words as you cross the valley. You may add 2 
    luck points for your success. On the other side of the bridge you 
  ...
  },
  {
    ...
    you recover your breath. A pouch around its waist contains 8 Gold 
    Pieces, You may also take any part of the creature that you think may 
    be useful. A large loaf in the cave is too large for you to carry, but you 
  ...
  },
  {
    ...
    choices: [
      ...
      { goToPage: 192, text: "Buy a drink and talk to the old man" },
      { goToPage: 96, text: "Buy a drink and talk to the young man" },
    ],
  },
  {
    id: 267,
    ...
    choices: [
      { goToPage: 8, text: "Buy a room for the night" },
  ...
  },
  {
    ...
    stung. When you reach the hive, you knock it down to the ground. 
    
    Cutting open the hive on the ground, you may take with you the wax 
    and the honey. The honey will provide you with enough nourish- 
    ment for one meal..`,
  ...
  },
  {
    ...
    unawares as a lightning blast flies towards you. Will you defend 
    yourself with a spell: 
    
    If you are a warrior you have no escape from the blast.
    
    ZIP GUM LAM FIL SUS 
    
    322 434 4*8 304 39* 
    
    If you know none of these, the blast hits you and charred remains are 
    all that are left of you. The Sorceress Gaza Moon must not be 
    ignored . . .`,
    choices: [
  ...
  },
  {
    ...
    you. Your guard is man-Jike but short and thin. You have been 
    captured by ELVINS! 
  ...
  },
  {
    ...
    choices: [
      ...
      { goToPage: 5, text: "Bag containing teeth" },
      { goToPage: 60, text: "Fine, glittering jewel" },
      { goToPage: 163, text: "Leave the merchant" },
    ],
  },
  {
    id: 281,
  ...
  {
    id: 283,
    text: `You settle down to make camp for the night. You may take Provisions 
    ...
    chance that you may encounter a wandering night creature. Remember 
    this reference (as you will return here afterwards) and turn to 123. 
    Night creatures are less likely to approach you in your camp, so you 
    may add 2 points to the die roll you will be required to make. 
    
    After your night's sleep you may add either 2 stamina points, if you 
    encountered no night creatures, ori stamina point if your sleep was 
    disturbed. Then you set off along the trail.`,
    choices: [{ goToPage: 31, text: "Continue.." }], // todo fight night creatures
  },
  {
    id: 284,
    text: `The loaf is not particularly pleasant, but is fairly nourishing. You may 
    make a meal of it and restore 2 stamina points.`,
    choices: [{ goToPage: 250, text: "Continue.." }],
  },
  {
    id: 285,
    text: `You may either fight the Ogre with your weapon or cast a spell.

    OGRE Skill 8 Stamina 7`,
    choices: [
  ...
  },
  {
    ...
    On your guard, you watch as it opens, allowing you into the room 
    inside.`,
  ...
  },
  {
    ...
    attacks the real you! If it choose the real you fight the monster. If it does not 
    choose the real you, you may escape from it and continue.`,
    choices: [
      { goToPage: 20, text: "Roll a 1: Fight" },
      { goToPage: 193, text: "Roll a 2 - 6: Continue" },
    ],
  },
  {
    id: 296,
  ...
  },
  {
    ...
    loudly. A Hanna runs off for water to douse the fire before her house 
  ...
  },
  {
    ...
    night's sleep. Add 2 stamina points.`,
  ...
  },
  {
    ...
    grazes your arm. Deduct 6 stamina points. Will now draw 
  ...
  {
    id: 304,
    text: `Deduct 5 stamin a points. You cast your spell but nothing happens. 
  ...
  },
  {
    ...
    not, you should not be at this reference and must deduct a further 3 
    stamina points as the Bandits attack and turn back to 104. If you 
    ...
    dance off, you condnue your journey.`,
    choices: [
      { goToPage: 104, text: "Spell fail - fail" },
  ...
  },
  {
    ...
    you back against a wait. Deduct another 2 stamina points.`,
  ...
  },
  {
    id: 314,
    text: `Deduct 5 stamina points. There is no such spell as this.`,
    choices: [{ goToPage: 0, text: "Go back and choose again" }],
  },
  {
    id: 315,
    text: `Deduct 5 stamina points. There is no such spell as this.`,
  ...
  },
  {
    ...
    yourself, but over one of the Eivins who seems to be in charge* The 
    ...
    together - and the sight is most amusing. Soon all the Eivins are 
  ...
  {
    id: 317,
    text: `Deduct 4 stamina points. You cast the spell and the creature looks 
    confused. It steps forwards and kicks the staff of the halberd, knock- 
    ing it out of its hands. Cursing, it picks the weapon up, merely to drop 
    it again! You may seize your chance and attack. While under the effect 
    of the spell, the Troll will fight at: 
    
    TROLL SENTRY skill 4 stamina 7 
    
    The speil will last for 4 Attack Rounds and will then wear off. Before 
    each Attack Round after the fourth, roll one die. If the number is odd, 
    the Troll cannot regain his halberd and will continue fighting with a 
    skill of 4. If you roll an even number, it will regain its weapon and 
    fight wiih a skill of 8.`,
    choices: [{ goToPage: 177, text: "Continue.." }],
  },
  {
    id: 318,
    ...
    down to sleep for the rest of the night. You may recover the 3 
    stamina points you would have lost for missing a night's sleep.`,
    choices: [{ goToPage: 263, text: "Continue.." }],
  },
  {
    id: 319,
  ...
  },
  {
    ...
    choices: [
      { goToPage: 0, text: "Continue" },
      { goToPage: 0, text: "Take the other path" },
    ],
  },
  {
    id: 322,
  ...
  },
  {
    ...
    choices: [
      { goToPage: 47, text: "Spell Success - Fight the goblins" },
  ...
  {
    id: 337,
    text: `Deduct 5 sta mina points. There is no such spell as this.`,
    choices: [{ goToPage: 158, text: "Go back and choose again" }],
  },
  {
    id: 338,
    text: `Deduct 4 stamina points. You cast the spell and the club drops out of 
    ...
    HILL GIANT skill 6 stamina 11`,
    choices: [{ goToPage: 265, text: "Continue.." }],
  },
  {
    id: 339,
    text: `Deduct 1 stamina point. Do you have a Bamboo Flute with you? If 
    ...
    towards the door.`,
    choices: [
      { goToPage: 87, text: "Spell fail - Go back and choose again" },
      { goToPage: 169, text: "Continue.." }, // todo add spell pass/fail
    ],
  },
  {
    id: 340,
  ...
  },
  {
    ...
    and the creature roars out in pain.`,
  ...
  },
  {
    ...
    of damage.`,
    choices: [{ goToPage: 0, text: "Return to fight them" }],
  },
  {
    id: 349,
    text: `Deduct 1 stamina point. You cannot cast this spell as you do not 
    have the Orb of Crystal it requires. Deduct a further 2 stamina 
  ...
  },
  {
    ...
    causing you some pain and the loss of another stamina point.`,
  ...
  },
  {
    ...
    choices: [{ goToPage: 217, text: "Return and fight" }], // todo must fight, no spell
  },
  {
    id: 359,
  ...
  },
  {
    id: 360,
    text: `Deduct 1 stamina point. Do you have any beeswax with you? If not, 
    you may not cast this spell. If you have 
    beeswax, you may wipe it on to your weapon to enhance its effect. 

    Try smashing the lock. But you may deduct 2 points 
    from the dice roll you make against skill and, if you succeed in 
    smashing the lock on your first attempt, you need not lose the skill 
    penalty.`,
    choices: [
      { goToPage: 4, text: "Spell fail - no beeswax" },
      { goToPage: 142, text: "Spell success - Try smashing the lock" },
    ], // todo better lock breaking chances
  },
  {
    id: 361,
    text: `Deduct 1 stamina point. Do you have a Giant's tooth?
 
    If you have found one on your travels, you drop it on the floor 
    ...
    You command him to fight: 
    
    HILL GIANT skill 9 stamina 11
    
    MAGICAL GIANT skill 8 stamina 9 
    
    Resolve this battle. If the Hill Giant defeats your champion, you will 
    have to finish the battle off yourself.`,
    choices: [{ goToPage: 265, text: "Continue.." }], // todo add giant fight that you take over from
  },
  {
    id: 362,
    text: `Deduct 1 stamina point. You cannot use this spell as you do not 
  ...
  },
  {
    ...
    choices: [{ goToPage: 99, text: "Fight the troll" }], // todo cant use magic at 99
  },
  {
    id: 364,
  ...
  {
    id: 369,
    text: `Do you have any Goblins' teeth with you? If so you may throw as 
    ...
    MANTICORE skill 12 stamina 18 
    GOBLINS SKILL 5 STAMINA 3 
    
    Each time the Manticore hits a Goblin, roll one die. On a roll of 5 or 6, it 
    will have stung with its poisonous tail, killing the Goblin. 1-4 is a 
    normal hit. Do your goblins win?
    If the Manticore defeats all your Goblins, you may either finish the job with your sword or cast another spell.`,
    choices: [
  ...
  },
  {
    ...
    use as you do not have the Pearl Ring it requires. Lose another 3 
    stamina points as the Bandits attack and return and
    another choice.`,
    choices: [{ goToPage: 104, text: "Return and fight the bandits" }],
  },
  {
    id: 372,
  ...
  {
    id: 375,
    text: `Deduct 2 stamina points. You cast the spell and wait for it to take 
    ...
    You may either fight it now in its incapacitated state (it will 
    fight with a skill of 4 and a stamina of 7). 
    Alternatively you may leave the room`,
    choices: [
      { goToPage: 15, text: "Fight the weakend monster and win" },
  ...
  },
  {
    ...
    spell. Return and fight it; for the first four Attack Rounds, the 
    Wood Golem will fight with a skill of 4,`,
    choices: [{ goToPage: 87, text: "Fight the Wood Golem" }], // todo weaken the golem
  },
  {
    id: 384,
    text: `Deduct 1 stamina point. You cast the spell and wait for something to 
  ...
  },
  {
    ...
    If you do have such a coin, you place it 
    ...
    Sentry with extra defence: 
    
    TROLL SENTRY skill 8 stamina 7 
    
    Because of your shield, you may deduct 2 from the Troll's throw on 
    Attack Strength. After the fight, you must lose 
    the Gold Piece, which becomes useless metal,`,
    choices: [
      { goToPage: 99, text: "Spell fail - choose again" },
      { goToPage: 177, text: "Fight the Troll Sentry and win" },
    ],
  },
  {
    id: 387,
  ...
  {
    id: 388,
    text: `Deduct 1 stamina point. Do you have a Giant's tooth with you?
    If not, you cannot cast this spell you must defend yourself 
    with your weapon. 
    
    If you do have a Giant's tooth, you place it on the 
    ...
    Giant to attack the Manticorc and it turns towards the startled beast. 
    Resolve this battle: 
    ...
    Each time the Manticore hits the Giant, you must roll one die. A roll of 
    ...
    normal damage. Does your Giant win? 
    If the Manticore wins, you may either finish the job off yourself or cast 
    another spell.`,
    choices: [
      { goToPage: 227, text: "Finish off the manticore" },
      { goToPage: 420, text: "Cast another spell" },
    ],
  },
  {
  ...
  },
  {
    ...
    hold it tightly over your face up to the ceiling. This you do. Test your 
  ...
  },
  {
    ...
    path?`,
    choices: [
      { goToPage: 0, text: "Continue down the path" },
      { goToPage: 0, text: "Return and take the other path" },
    ],
  },
  {
    id: 395,
  ...
  },
  {
    ...
    at an advantage. Turn back to 285 and fight the Ogre, hut you may 
  ...
  },
  {
    ...
    choices: [
      { goToPage: 218, text: "Spell Fail - continue" },
      { goToPage: 196, text: "Spell Pass - continue" },
    ],
  },
  {
    id: 402,
    ...
    choices: [{ goToPage: 74, text: "Continue.." }],
  },
  {
    id: 403,
    ...
    leave the village.`,
    choices: [
      { goToPage: 258, text: "Try the other box" }, // todo if havent before
      { goToPage: 196, text: "Leave the village" },
    ],
  },
  {
  ...
  {
    id: 407,
    text: `Deduct 4 stamina points. You cast the spell and point at the first 
    ...
    turn and flee into the woods. Otherwise it will, continue its attack. 
    Their scores are: 
    ...
    THIRD GOBLIN skill 5 stamina 5`,
    choices: [
      { goToPage: 155, text: "Fight the goblin(s) and then continue." },
      { goToPage: 202, text: "They both flee" },
    ],
  },
  {
    id: 408,
  ...
  {
    id: 411,
    text: `Deduct 2 stamina points. You cast the spell and wait. Slowly, the 
    ...
    But you may double your skill while you are under the influence of 
    this spell.`,
    choices: [{ goToPage: 265, text: "Fight the golem and win" }],
  },
  {
    id: 412,
    text: `Deduct 5 stamina points. There is no such spell as this.`,
  ...
  },
  {
    ...
    ... If you have survived, turn back to 63 and choose again.`,
    choices: [
      { goToPage: 63, text: "Roll a 1-5, you survived" },
  ...
  {
    id: 420,
    text: `You may turn fight the creature with your weapon. Otherwise, choose 
    your spell`,
    choices: [
  ...
  {
    id: 424,
    text: `Deduct 2 stamin a points. You fall down into the pit, but your body 
  ...
  },
  {
    ...
    must deduct 1 stamina point per Goblin you create. Each Goblin will 
    have a skill of 5 and a stamina of 5 and you may command an 
    attack on the Wolfhound. Do your creations kill the beast?, if not finish it off yourself. If you do not 
    have any Goblins' teeth, then you try in vain to cast the spell and the 
    Wolfhound leaps at your throat, causing you 3 stamina points' 
    worth of damage - you will have to fight it: 
    
    WOLFHOUND skill 7 stamina 6`,
    choices: [
      { goToPage: 50, text: "The goblins killed the Wolfhound" },
      { goToPage: 0, text: "Continue.." },
  ...
  },
  {
    ...
    damage. You may, if you wish, Testyour Luck and if you are Lucky you 
    avoid this attack.`,
    choices: [{ goToPage: 217, text: "Fight the goblins or cast a spell" }], // todo test your luck
  },
  {
    id: 429,
    text: `Deduct 1 stamina point. You cannot use this spell as you do not 
  ...
  },
  {
    ...
    from Libra. But if you have already used her help, there is 
    little you can do but hold the snakes off until your stamina runs out- 
    your journey has ended here . . . `,
    choices: [{ goToPage: 273, text: "Call on Libra" }], // todo you are dead
  },
  {
    id: 434,
    text: `Deduct 1 STAMINA point. You cast the spell but nothing happens. 
  ...
  },
  {
    ...
    choices: [
      ...
      { goToPage: 203, text: "Return and fight the Elvin" },
    ],
  },
  {
    id: 442,
    ...
    choices: [
      { goToPage: 217, text: "Fight the goblins with double damage" },
      { goToPage: 217, text: "Fight the goblins normally" },
    ],
  },
  {
    id: 443,
  ...
  },
  {
    ...
    the creature you may return to your original reference.`,
    choices: [], // todo where does this come from?
  },
  {
    id: 449,
  ...
  },
  {
    ...
    choices: [
      ...
      { goToPage: 123, text: "Fight the creature with double skill" },
    ],
  },
  {
    id: 454,
  ...
  {
    id: 456,
    text: `You leave the Manticore's chamber and follow the path to the source 
    ...
    you may you wish to use this key. 
    
    You thank him and leave Torrepani. You have made friends here and 
    may permanently increase your Initial luck score by 1 point. Soon the 
